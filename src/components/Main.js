...
export default function Main() {
  ...
  return (
    <div className="px-80 py-7 bg-white dark:bg-gray-800 min-h-screen">
      <div className="container mb-9">
        <input
          type="text"
          placeholder="https://www.youtube.com/playlist?list=PL6rBC_87VKs76V9Vc0s44Gg_Q6qObZrFY"
          className="placeholder:italic placeholder:text-slate-400 border-2 rounded-lg py-1.5 px-3 w-4/5 shadow-md shadow-gray-500/50 dark:bg-gray-600 dark:text-white dark:placeholder:text-gray-300 dark:shadow-sm dark:shadow-gray-600 dark:focus:outline-gray-400 bg-white focus:outline-1 focus:outline-red-500"
          onChange={(e) => setLink(e.target.value)}
        />
        <button
          type="button"
          className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300  shadow-lg shadow-red-500/50   font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-2 w-1/6 dark:focus:ring-red-800"
